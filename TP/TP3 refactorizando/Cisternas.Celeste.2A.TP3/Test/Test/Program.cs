...
namespace Test
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //ARCHIVOS XML
            Archivos.GuardarXml(Environment.GetFolderPath(Environment.SpecialFolder.Desktop) + "\\XML.xml", wiki);
            wiki = Archivos.LeerXml(Environment.GetFolderPath(Environment.SpecialFolder.Desktop) + "\\XML.xml");
        }
    }
}
